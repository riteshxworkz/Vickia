...
class RegisteredUserController extends Controller
{
    ...
    public function createNewUser(Request $request)
    {
        ...
        $get_free_subscription = SubscriptionPlan::where('id', 1)->first();
        ...
        $user->available_words = $get_free_subscription->words; //config('settings.free_tier_words');
        $user->available_dalle_images = $get_free_subscription->dalle_images; //config('settings.free_tier_dalle_images');
        $user->available_sd_images = $get_free_subscription->sd_images;//config('settings.free_tier_sd_images');
        $user->available_chars = $get_free_subscription->characters; //config('settings.voiceover_welcome_chars');
        $user->available_minutes = $get_free_subscription->minutes; //config('settings.whisper_welcome_minutes');
