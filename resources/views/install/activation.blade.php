                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12">								
                                            <div class="input-box">								
                                                ...
                                                <div class="form-group">							    
                                                    <input type="text" class="form-control @error('license') is-danger @enderror" id="license" name="license" value="{{ old('license') }}" placeholder="Enter any code" autocomplete="off" required>
                                                    @error('license')
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12">								
                                            <div class="input-box">								
                                                ...
                                                <div class="form-group">							    
                                                    <input type="text" class="form-control @error('username') is-danger @enderror" id="username" name="username" value="{{ old('username') }}" placeholder="Enter any Username" autocomplete="off" required>
                                                    @error('username')
