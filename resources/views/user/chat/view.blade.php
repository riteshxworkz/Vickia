...
<!--                <textarea class="form-control" id="embedCodeTextarea" rows="4" readonly></textarea>-->
<!--            </div>-->
...
<div class="modal fade" id="embedCodeModal" tabindex="-1" aria-labelledby="embedCodeModalLabel" aria-hidden="true">
				...
				<div class="chat-message-container" id="chat-system">
					<div class="card-header">
						...
						<div class="w-50 text-right pt-2 pb-2">				
							...
							<!--<a id="embed-chat" class="template-button mr-2" onclick="embedChat();" href="#"><i class="fa-solid fa-code table-action-buttons table-action-buttons-big edit-action-button" data-tippy-content="{{ __('Embed Code') }}"></i></a>-->
						    ...
						    <button id="embed-chat" class="" data-bs-toggle="modal" data-bs-target="#embedCodeModal" style="border:none; background:none;"><i class="fa-solid fa-code table-action-buttons table-action-buttons-big edit-action-button" data-tippy-content="{{ __('Embed Code') }}"></i></button>
	...
	<!--<iframe src="https://vickia.fr/user/chat" style="border:0px #ffffff none;" name="myiFrame" scrolling="yes" frameborder="1" marginheight="0px" marginwidth="0px" height="600px" width="1000px" allowfullscreen></iframe>-->
...
<script>
    ...
    // function generateEmbedCode(chatURL, width, height) {
        
    //     var embedCode = '<iframe src="' + chatURL + '" width="600" height="400" frameborder="0"></iframe>';
        
    //     return embedCode;
    // }
    //   function embedChat() {
    //     var chatURL = 'https://vickia.fr/user/chat/';
       
    //     var embedCode = generateEmbedCode(chatURL, width, height);
    //     document.getElementById('embedCodeTextarea').value = embedCode;
    // }

  function generateEmbedCode(chatURL, width, height) {
    var embedCode = '<iframe src="' + chatURL + '" width="' + width + '" height="' + height + '" frameborder="0"></iframe>';
    return embedCode;
}

function embedChat() {
    var chatURL = "{{ route('public.chat', ['code' => $chat->chat_code, 'userId' => $user_id,'internet'=>$internet, 'user_plan_id'=> $user_plan_id , ] ) }}";
    var width = '600';
    var height = '400';
    var embedCode = generateEmbedCode(chatURL, width, height);
    document.getElementById('embedCodeTextarea').value = embedCode;
...
document.getElementById('embed-chat').addEventListener('click', function() {
    embedChat();
});
