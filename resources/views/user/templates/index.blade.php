											...
											@if ($template->group == $category->code)
												<div class="col-lg-3 col-md-6 col-sm-12">
													<div class="template">
														...
														@if(auth()->user()->group == "admin")<a href="@if($template->user_id) {{route("user.templates.custom.show",  $template->id )}} @else {{route("user.original-template.custom.show", $template->id )}} @endif"><i class="fa fa-edit table-action-buttons view-action-button" title="'. __('Edit Template') .'"></i></a>@endif
