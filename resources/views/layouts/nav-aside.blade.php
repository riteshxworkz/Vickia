...
<aside class="app-sidebar"> 
    ...
    <ul class="side-menu app-sidebar3">
        ...
        <li class="slide">
            <a class="side-menu__item" href="{{ route('user.openai') }}">
            <span class="side-menu__icon lead-3 fa-solid fa-chart-tree-map"></span>
            <span class="side-menu__label">{{ __('Open AI') }}</span></a>
        </li> 
        <li class="slide">
        ...
        @role('admin')
            ...
            <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('#')}}">
                        ...
                        <span class="side-menu__label">{{ __('Vickia Management') }}</span><i class="angle fa fa-angle-right"></i>
                    </a>
                    <ul class="slide-menu">
                        <li><a href="{{ route('admin.davinci.dashboard') }}" class="slide-item">{{ __('Vickia Dashboard') }}</a></li>
                        <li><a href="{{ route('admin.davinci.templates') }}" class="slide-item">{{ __('Vickia Templates') }}</a></li>
                        ...
                        <li><a href="{{ route('admin.davinci.configs') }}" class="slide-item">{{ __('Vickia Settings') }}</a></li>
                    </ul>
            </li>
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('#')}}">
