						...
						<div class="card mt-6 mb-7 special-shadow border-0">
							<div class="card-body">
								...
								<div class="row">
									...
									<div class="col-lg-6 col-md-6 col-sm-12">							
										<div class="input-box">								
											<h6>{{ __('Total Dalle Images Included in the Plan') }} <span class="text-required"><i class="fa-solid fa-asterisk"></i></span> <span class="text-muted ml-3">({{ __('Renewed Monthly') }})</span></h6>
											<div class="form-group">							    
												<input type="number" class="form-control" id="dalle-images" name="dalle-images" value="{{ old('dalle-images') }}">
									...
									<div class="col-lg-6 col-md-6 col-sm-12">							
										<div class="input-box">								
											<h6>{{ __('Total Stable Diffusion Images Included in the Plan') }} <span class="text-required"><i class="fa-solid fa-asterisk"></i></span> <span class="text-muted ml-3">({{ __('Renewed Monthly') }})</span></h6>
											<div class="form-group">							    
												<input type="number" class="form-control" id="sd-images" name="sd-images" value="{{ old('sd-images') }}">
												<span class="text-muted fs-10">{{ __('Valid for all image sizes') }}. {{ __('Set as -1 for unlimited images') }}.</span>
											</div> 
											@error('sd-images')
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="input-box">
											...
											<select id="default-model-user" name="model" class="form-select" data-placeholder="{{ __('Select OpenAI Model Type') }}:">
												<option value="gpt-4o-mini" selected>{{ __('GPT 4o Mini') }}</option>
												<option value="gpt-4o" selected>{{ __('GPT 4o') }}</option>
												...
												<option value="gpt-4-0125-preview">{{ __('GPT 4 Turbo') }} ({{ __('gpt-4-0125-preview') }})</option>
									...
									<div class="row">
										...
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="input-box">
												<h6>{{ __('OpenAI Image Engine') }} <i class="ml-3 text-dark fs-13 fa-solid fa-circle-info" data-tippy-content="{{ __('Make sure that AI Image Feature is Enabled first and also that this AI Image vendor is enabled in your Vickia Settings page') }}."></i></h6>
										...
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="input-box">
												<h6>{{ __('Stable Diffusion Image Engine') }} <i class="ml-3 text-dark fs-13 fa-solid fa-circle-info" data-tippy-content="{{ __('Make sure that AI Image Feature is Enabled first and also that this AI Image vendor is enabled in your Vickia Settings page') }}."></i></h6>
										...
										<div class="col-lg-6 col-md-6 col-sm-12">							
											<div class="input-box">								
												...
												<div class="form-group">							    
													<input type="number" class="form-control" min="0.1" step="0.1" id="chat-csv-file-size" name="chat-csv-file-size" value="{{ old('chat-csv-file-size') }}">
										...
										<div class="col-lg-6 col-md-6 col-sm-12">							
											<div class="input-box">								
												...
												<div class="form-group">							    
													<input type="number" class="form-control" min="0.1" step="0.1" id="chat-pdf-file-size" name="chat-pdf-file-size" value="{{ old('chat-pdf-file-size') }}">
													<span class="text-muted fs-10">{{ __('Maximum Size limit is in Megabytes (MB)') }}.</span>
												</div> 
										...
										<div class="col-lg-6 col-md-6 col-sm-12">							
											<div class="input-box">								
												...
												<div class="form-group">							    
													<input type="number" class="form-control" min="0.1" step="0.1" id="chat-word-file-size" name="chat-word-file-size" value="{{ old('chat-word-file-size') }}">
													<span class="text-muted fs-10">{{ __('Maximum Size limit is in Megabytes (MB)') }}.</span>
												</div> 
										...
										<div class="col-lg-6 col-md-6 col-sm-12">							
											<div class="input-box">								
												...
												<div class="form-group">							    
													<input type="number" class="form-control" min="0" id="voice_clone_number" name="voice_clone_number" value="{{ old('voice_clone_number') }}">
												</div> 
										...
										<div class="col-lg-6 col-md-6 col-sm-12">							
											<div class="input-box">								
												...
												<div class="form-group">							    
													<input type="number" class="form-control" min="0" id="plagiarism-pages" name="plagiarism-pages" value="{{ old('plagiarism-pages') }}">
												</div> 
										...
										<div class="col-lg-6 col-md-6 col-sm-12">							
											<div class="input-box">								
												...
												<div class="form-group">							    
													<input type="number" class="form-control" min="0" id="detector-pages" name="detector-pages" value="{{ old('detector-pages') }}">
												</div> 
										...
										<div class="col-lg-6 col-md-6 col-sm-12">							
											<div class="input-box">								
												...
												<div class="form-group">							    
													<input type="number" class="form-control" id="file-result-duration" name="file-result-duration" value="{{ old('file-result-duration') }}">
										...
										<div class="col-lg-6 col-md-6 col-sm-12">							
											<div class="input-box">								
												...
												<div class="form-group">							    
													<input type="number" class="form-control" id="document-result-duration" name="document-result-duration" value="{{ old('document-result-duration') }}">
													<span class="text-muted fs-10">{{ __('Set as -1 for unlimited storage duration') }}.</span>
												</div> 
										...
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="input-box">
												<h6>{{ __('Supported AI Voiceover Vendors') }} <i class="ml-3 text-dark fs-13 fa-solid fa-circle-info" data-tippy-content="{{ __('Only listed TTS voices of the listed vendors will be available for the subscriber. Make sure to include respective vendor API keys in the Vickia settings page.') }}."></i></h6>
