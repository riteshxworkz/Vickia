									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="input-box">
											...
											<select id="default-model-user" name="model" class="form-select" data-placeholder="{{ __('Select OpenAI Model Type') }}:">
												...
												<option value="gpt-4-0125-preview" @if ( $id->model == 'gpt-4-0125-preview') selected @endif>{{ __('GPT 4 Turbo') }} ({{ __('gpt-4-0125-preview') }})</option>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="input-box">
											...
											<select id="default-model-chat-user" name="chat-model" class="form-select" data-placeholder="{{ __('Select OpenAI Model Type') }}:">
												<option value="gpt-4o-mini"@if ($id->model_chat == 'gpt-4o-mini') selected @endif>{{ __('GPT 4o Mini') }}</option>
												<option value="gpt-4o"@if ($id->model_chat == 'gpt-4o') selected @endif>{{ __('GPT 4o') }}</option>
												...
												<option value="gpt-4-0125-preview" @if ( $id->model_chat == 'gpt-4-0125-preview') selected @endif>{{ __('GPT 4 Turbo') }} ({{ __('gpt-4-0125-preview') }})</option>
