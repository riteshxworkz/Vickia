...
Route::group(['prefix' => 'user', 'middleware' => ['UserSessionHandle','verified', '2fa.verify', 'role:user|admin|subscriber', 'subscription.check', 'PreventBackHistory']], function() {
    ...
    Route::get('/open-ai', [UserDashboardController::class, 'chatModule'])->name('user.openai');
    ...
    Route::controller(TemplateController::class)->group(function () {
        ...
        Route::get('/templates/original-template/{id}/show', 'show')->name('user.original-template.custom.show');
        Route::put('/templates/original-template/{id}/update', 'update')->name('user.original-templates.custom.update');
    });
    ...
    Route::controller(EmbeddingFileController::class)->group(function () {
        ...
        Route::post('/chat/file/store', 'embed');
    });
...
// Embed user chat
Route::get('/public-chat/{code}/{userId}/{internet}/{user_plan_id?}', [ChatController::class, 'publicChat'])->name('public.chat');
